...
const JapaneseStats: React.FC = (): JSX.Element => {
  return (
    <div className = "japanese-card w-full h-full shadow-lg bg-white rounded-3xl flex flex-col justify-centeritems-ce overflow-hidden font-[Poppins]">
        <div className = "flex justify-center flex-col">
            <div className = "japanese-ability-box w-full h-1/4 flex flex-col justify-center gap-0 mt-5">
