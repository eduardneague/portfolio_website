  ...
  return (
    <>
        <div className = "rounded-3xl bg-very-light-gray h-[21rem] w-[22rem] shadow-lg flex flex-col font-[Poppins]">
            ...
            <h1
                className="eduard-text ml-5 font-extrabold text-transparent text-[40px] bg-gradient-to-r from-black to-custom-pink"
            >
            Eduard Neague
            </h1>
            <p className = "text-[14px] leading-6 ml-5 mt-3">I am a 
                <span className="h-[2.6rem] font-extrabold text-transparent text-[14px]  bg-gradient-to-r from-black to-custom-pink"> Frontend Developer </span> 
                 and <span className="h-[2.6rem] font-extrabold text-transparent text-md  bg-gradient-to-r from-black to-custom-pink"> UX Designer </span>
